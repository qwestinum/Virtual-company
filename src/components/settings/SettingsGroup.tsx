 ...
 * l'écran — le titre de famille porte un FILET `--dash-famille` (#ebbb58),
 * sans aplat (23/09/2026, demande du donneur d'ordre).
 * ⚠️ Le texte, lui, reste en encre du produit : ce jaune EN TEXTE sur fond
 * clair ne tient pas 2:1. La couleur borde, elle n'écrit pas.
 *
