...
export function buildConversationalPrompt(
  ...
  return [
    ...
    '- "inline" : proposition argumentée d\'une valeur libre (salary_range, start_date, missions, skills) — chips d\'ajustement nommés (« Plus haut », « Plus bas », « Utiliser cette valeur »).',
