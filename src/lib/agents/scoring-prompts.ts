...
export function buildScoringSystemPrompt(): string {
  return [
    ...
    '{',
    '  "criteria": [',
    '    { "label": "Diplôme comptable Bac+5 (DSCG/DEC ou équivalent)", "level": "obligatoire" },',
    '    { "label": "5+ ans d\'expérience en comptabilité générale", "level": "obligatoire" },',
    '    { "label": "Maîtrise des normes IFRS", "level": "critique" },',
    '    { "label": "Expérience de consolidation", "level": "critique" },',
    '    { "label": "Pratique avérée de SAP", "level": "tres_important" },',
    '    { "label": "Excel avancé (TCD, recherchev, macros)", "level": "tres_important" },',
    '    { "label": "Expérience supervision juniors", "level": "important" },',
    '    { "label": "Anglais courant écrit/oral", "level": "important" },',
    '    { "label": "Expérience en cabinet Big 4 ou ETI", "level": "souhaitable" }',
    '  ]',
    '}',
    '',
    ...
    '{',
    '  "criteria": [',
    '    { "label": "<verbe + objet>", "level": "<un des 6 niveaux>" }',
    '  ]',
    '}',
    "Aucun champ supplémentaire. Pas de poids — les poids sont dérivés du niveau côté serveur.",
  ].join('\n');
}
