...
export function buildScoringSystemPrompt(): string {
  return [
    ...
    '- "redhibitoire" : KNOCKOUT. Si le CV ne le démontre pas → écarté d\'office. À utiliser AVEC PARCIMONIE (1 à 2 critères max, vraiment non négociables : ex. « Diplôme expertise comptable DEC pour un poste expert-comptable », « Permis B pour un commercial terrain »). Pas de critère vague type « rigueur ».',
    '- "critique" : compétence ou expérience-clé du poste, écart possible mais coûteux. Niveau le plus FORT pour un must-have non éliminatoire (poids le plus élevé). 2 à 5 critères.',
    ...
    '{',
    '  "criteria": [',
    '    { "label": "Diplôme comptable Bac+5 (DSCG/DEC ou équivalent)", "level": "critique", "verificationMethod": "keywords_exact", "keywords": ["DSCG", "DEC", "Bac+5 comptabilité"] },',
    '    { "label": "5+ ans d\'expérience en comptabilité générale", "level": "critique", "verificationMethod": "hybrid_keywords_llm", "keywords": ["comptabilité générale", "comptable"] },',
